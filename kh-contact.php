...
class Contact_Info_Plugin {
    ...
    public function __construct() {
        ...
        register_deactivation_hook(__FILE__,  array($this,'delete_custom_table_on_activation'));
    ...
    function delete_custom_table_on_activation() {
        global $wpdb;
...
new Contact_Info_Plugin_Settings();
//new GenieSettings();